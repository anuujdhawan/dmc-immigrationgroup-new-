...
// TEMPORARY copy of Hero.tsx — AlternativeHero for A/B checking on the homepage.
// Desktop: identical to Hero. Mobile: plain light-green band from the moment the
// orbit animation sits under the hero text (scoped via the `alternative-hero` class
// in globals.css). Remove this file once the check is done.
