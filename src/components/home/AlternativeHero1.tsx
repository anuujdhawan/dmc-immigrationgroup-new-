...
// It must SWAP the existing hero, never render alongside it — if both are on the
// page, getElementById resolves to the first and the second hero's animations
// and SVG gradients break.
...
export interface AlternativeHero1Props {
  market: Market;
  sectionId?: string;
  eyebrow?: string;
  titlePrefix?: string;
...
export function AlternativeHero1({
  market,
  sectionId = "home",
  ...
  return (
    <section
      ref={heroRef}
      id={sectionId}
      className="hero aurora-hero botanical-hero editorial-hero alternative-hero alternative-hero-1"
